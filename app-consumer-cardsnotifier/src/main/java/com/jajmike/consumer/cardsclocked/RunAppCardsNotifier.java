package com.jajmike.consumer.cardsclocked;
...
@Slf4j
@EnableScheduling
public class RunAppCardsNotifier {

	/**
	 * - Main method to execute  AppCardsNotifier
	 * @param args {@link org.springframework.context.ConfigurableApplicationContext}
	 */
	public static void main(String[] args) {
		SpringApplication.run(RunAppCardsNotifier.class, args);
	}
}
